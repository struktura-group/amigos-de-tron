    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white">
      <header className="border-b border-gray-800 bg-black/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            {isOwner && (
              <Link to="/admin" className="hover:text-red-500 transition-colors">Administrador</Link>
            )}
          </nav>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <Badge className="mb-6 bg-red-500/20 text-red-400 border-red-500/50">
          Sistema de Matriz 1×2 Global con Distribución Inteligente
        </Badge>
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-4 max-w-3xl mx-auto">
          Plataforma Descentralizada de Crowdfunding en Blockchain TRON
        </p>
        <p className="text-lg text-gray-400 mb-8 max-w-3xl mx-auto">
          Una única matriz 1×2 alimentada por 3 planes diferentes. Cuando completas tu ciclo (2 posiciones), recibes 10 TRX + 2.5 TRX va a tu sponsor + 5 TRX al fondo de reinversión + 5.5 TRX se queman + 2 TRX reserva de gas + 25 TRX para reposicionarte automáticamente.
        </p>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">Todos alimentan la misma matriz - Distribución inteligente por ciclo</p>
          {!isConnected && (
      ...
      <section className="container mx-auto px-4 py-16">
        <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-green-500/30 p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold mb-2">Sistema Transparente y Sostenible</h2>
            <p className="text-xl text-green-400 font-semibold">Distribución Inteligente de 50 TRX por Ciclo</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold mb-2">Una Sola Matriz 1x2 Global</h3>
                <p className="text-gray-400 text-sm">
                  Todos los planes alimentan la misma matriz. Asignación automática y transparente sin preferencias.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              <CheckCircle2 className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-bold mb-2">Distribución por Ciclo</h3>
                <p className="text-gray-400 text-sm">
                  10 TRX al usuario + 2.5 TRX al sponsor + 5 TRX reinversión + 5.5 TRX quema + 2 TRX gas + 25 TRX reposición.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  El fondo crea cuentas automáticamente cada 25 TRX acumulados, manteniendo la matriz activa permanentemente.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Publicidad gratuita durante 90 días desde el registro para todos los usuarios nuevos.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t border-gray-800 bg-black/50 backdrop-blur-sm py-8">
        <div className="container mx-auto px-4 text-center text-gray-400">
          ...
          <p className="text-sm">
            Sistema de matriz 1x2 con distribución inteligente - 50 TRX por ciclo
          </p>
        </div>
      </footer>
    </div>

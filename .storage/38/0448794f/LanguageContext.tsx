...
const translations: Translations = {
  ...
  // Wallet Connection
  'wallet.connect': { es: 'Conectar Wallet', en: 'Connect Wallet', pt: 'Conectar Carteira' },
  'wallet.connecting': { es: 'Conectando...', en: 'Connecting...', pt: 'Conectando...' },
  'wallet.disconnect': { es: 'Desconectar', en: 'Disconnect', pt: 'Desconectar' },
  'wallet.myWallet': { es: 'Mi Wallet', en: 'My Wallet', pt: 'Minha Carteira' },
  'wallet.address': { es: 'Dirección', en: 'Address', pt: 'Endereço' },
  'wallet.balance': { es: 'Balance', en: 'Balance', pt: 'Saldo' },
  'wallet.notInstalled': { es: 'TronLink no instalado', en: 'TronLink not installed', pt: 'TronLink não instalado' },
  'wallet.installPrompt': { es: 'Por favor instala la extensión TronLink para continuar', en: 'Please install TronLink extension to continue', pt: 'Por favor, instale a extensão TronLink para continuar' },
  
  connectWallet: { es: 'Conectar Wallet', en: 'Connect Wallet', pt: 'Conectar Carteira' },
  connectWalletDescription: { es: 'Conecta tu wallet TronLink para activar tu cuenta', en: 'Connect your TronLink wallet to activate your account', pt: 'Conecte sua carteira TronLink para ativar sua conta' },
  walletConnected: { es: 'Wallet Conectada', en: 'Wallet Connected', pt: 'Carteira Conectada' },
  disconnectWallet: { es: 'Desconectar Wallet', en: 'Disconnect Wallet', pt: 'Desconectar Carteira' },
  connectTronLink: { es: 'Conectar TronLink', en: 'Connect TronLink', pt: 'Conectar TronLink' },
  connecting: { es: 'Conectando', en: 'Connecting', pt: 'Conectando' },
  needTronLink: { es: 'Necesitas tener TronLink instalado en tu navegador', en: 'You need to have TronLink installed in your browser', pt: 'Você precisa ter o TronLink instalado no seu navegador' },
  walletConnectionError: { es: 'Error al conectar wallet', en: 'Error connecting wallet', pt: 'Erro ao conectar carteira' },
};
